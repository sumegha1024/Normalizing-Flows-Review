...
tuning_dict= {'2_50':[101000,20000,20000,64,10],'2_100':[101000,20000,20000,64,10], '2_200':[101000,20000,20000,64,10], '20_50':[101000,20000,20000,64,10],'20_100':[101000,20000,20000,64,10],'20_200':[101000,30000,20000,64,10],
   '50_50':[101000,20000,100000,64,10],'50_100':[101000,20000,30000,64,10],'50_200':[101000,20000,20000,64,10],'100_50':[101000,30000,800000,128,10],'100_100':[101000,30000,650000,128,10],'100_200':[101000,30000,30000,128,10]}
...
if args.sigma_prior==True:
    ...
    plt.xlabel(r'$\sigma^{2}$',fontsize=22)
    plt.ylabel("Density",fontsize=22)
    plt.yticks(fontsize=18)
    plt.xticks(fontsize=20)
    plt.legend(fontsize=20)
    plt.tight_layout()
    plt.savefig(args.out+'sigmasq'+str(args.seed)+'_ndata_'+str(args.n_data)+'_p_'+str(args.data_dim)+'.pdf')
    plt.clf()
...
plt.xlabel(r'$\beta_{1}$',fontsize=22)
plt.ylabel(r'$\beta_{2}$',fontsize=22)
...
plt.legend(fontsize=20)
plt.ylabel('Density of '+r'$||\beta-\beta_{0}||_{2}^{2}$',fontsize=22)
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
plt.tight_layout()
