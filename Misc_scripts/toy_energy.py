'''This script includes the functions for toy energy densities and generates the corresponding plots'''
import torch as T
import sys, os
...
##All energy functions return the log density
def U1(Z):
    z1 = Z[:,0]
